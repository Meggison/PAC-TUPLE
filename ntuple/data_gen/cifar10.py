...
# print("Testing CIFAR-10 Triplet Dataset...")
# triplet_dataset = CIFAR10TupleDataset(train=True, samples_per_class=100)
# print(f"Dataset length: {len(triplet_dataset)}")
# print(f"Valid classes: {triplet_dataset.valid_classes}")
...
#     # Test the N-tuple dataset
# print("\nTesting CIFAR-10 N-Tuple Dataset...")
# ntuple_dataset = CIFAR10NTupleDataset(train=True, num_negatives=4, samples_per_class=100)
    
# anchor, positive, negatives = ntuple_dataset[0]
# print(f"Anchor shape: {anchor.shape}")
# print(f"Positive shape: {positive.shape}")
# print(f"Negatives shape: {negatives.shape}")  # Should be [4, 3, 32, 32]
